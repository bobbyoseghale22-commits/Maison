...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-foreground/90 backdrop-blur-sm",
  ...
  <DialogPortal>
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          "absolute -top-12 right-0 flex h-9 w-9 items-center justify-center",
          "text-background/80 transition-colors hover:text-background",
